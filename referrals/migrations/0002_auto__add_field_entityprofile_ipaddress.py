...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityProfile.ipaddress'
        db.add_column('referrals_entityprofile', 'ipaddress',
                      self.gf('django.db.models.fields.CharField')(default=True, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityProfile.ipaddress'
        db.delete_column('referrals_entityprofile', 'ipaddress')
    ...
    models = {
        ...
        'referrals.entityprofile': {
            ...
            'ipaddress': ('django.db.models.fields.CharField', [], {'default': 'True', 'max_length': '100', 'null': 'True'}),
